...
Do not send workers:
- Ambiguous strategy questions without context
- Mixed research plus production plus QA in one brief
- Tasks with no output format
- Tasks that require final business judgment without escalation rules

## Brief template

Use this pattern when assigning work:
